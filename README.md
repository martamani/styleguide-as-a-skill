...
**The problem:** My last project [LLM as a judge](https://github.com/martamani/llm-as-a-judge) checked *translations* against a styleguide — two languages, judging text that already existed. That's a hard problem, and it pulled me into Python, loops, and databases. I don't code.
